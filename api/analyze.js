export default async function handler(req, res) {
    ...
    try {
        ...
        // Mengambil kumpulan API Key dari Environment Variable
        const keys = [];
        ...
        // Update Prompt: Menginstruksikan AI untuk membaca Daun, Batang, atau Akar
        ...
        if (plantName && plantName.trim() !== "") {
            promptText += `\nTanaman ini diidentifikasi pengguna sebagai: ${plantName}. Tolong fokuskan analisis pada penyakit yang sering menyerang tanaman ini berdasarkan visual yang terlihat.`;
        }
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            try {
                ...
                if (!response.ok) {
                    // Jika error karena Rate Limit/Kuota Habis (Status 429), catat dan coba key berikutnya
